    ...
    class Program
    {
        ...
        private static void DisplayMainMenu()
        {
            ...
            if (Int32.TryParse(userChoice, out choice))
            {
                ...
                Contacts.SelectedContact = Contacts.Get(choice);
        ...
        private static void SelectedContactMenu()
        {
            ...
            while (isValid)
            {
                ...
                Console.WriteLine("---------------------\n");
                Contacts.DisplayAllTasks(false);
                ...
                if (Int32.TryParse(userChoice, out choice))
                {
                    ...
                    TaskModel selectedTask = Contacts.GetTask(choice);
        ...
        private static void SearchTaskMenu()
        {
            ...
            Contacts.DisplayTasks(Contacts.SearchTask(keyword));
        }
            ...
            while (isValid)
            {
                ...
                switch (userChoice)
                {
                    case "n":
                        ...
                        Contacts.UpdateName(selectedTask);
                        break;
                    case "d":
                    ...
                    case "c":
                        ...
                        break;
                    case "r":
                        Contacts.RemoveTask(selectedTask);
                        isValid = false;
                        break;
                    case "b":
                        isValid = false;
        ...
        private static void AddTaskMenu()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    // If the size is too large, it will throw an error here
                    TaskModel newTask = new TaskModel(newName, newDescription, SelectedContact.ID);
                    SelectedContact.Tasks.Add(newTask);
                    Contacts.AddTask(newTask);
                    return;
                }
                // If the exceptions are caught, loop will continue.
                catch (ArgumentNullException ex)
